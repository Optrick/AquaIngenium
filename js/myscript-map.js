...
function initMap() {
  ...
  var GaspesieLocation = {lat: 48.8445157,  
                  lng: -67.5305758};
  var centerPoint = {lat: 48.22095236703228,  
  ...
  var infoContentQc = '<a href="#"><i class="icon-phone"></i> 418 997-8689</a><br>';
      infoContentQc += '14, rue du Domaine<br>';
      infoContentQc += 'Sainte-Anne-de-Beaupré, Qc<br>';
      infoContentQc += 'G0A 3C0';

  var infoContentSag = '<a href="#"><i class="icon-phone"></i> 418 482‐1620</a><br>';
      infoContentSag += '1015, rue Duguay<br>';
      infoContentSag += 'Alma, Qc<br>';
      infoContentSag += 'G8B 1W4';

  var infoContentGasp = '<a href="#"><i class="icon-phone"></i> 418 932-7082</a><br>';
      infoContentGasp += '616, Saint-Rédempteur<br>';
      infoContentGasp += 'Matane, Qc<br>';
      infoContentGasp += 'G4W 1L1';
